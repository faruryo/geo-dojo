...
function sharedBuildOptions({ nodePaths, tsconfig }) {
  ...
  return {
    ...
    // design-sync fork: geo-dojo pulls next/link + next/dynamic and reads
    // NEXT_PUBLIC_GOOGLE_MAPS_API_KEY, all of which touch bare `process`.
    // Without this the IIFE throws on load and window.GeoDojo stays empty.
